					...
					<div class="col-sm-10 col-sm-offset-1">
						<div class="login-container">
							<div class="center animated bounceInLeft">
								...
								<h4 class="blue" id="id-company-text">&copy; SISTEMA DE FACTURACIÓN</h4>
							</div>
												...
												<fieldset>
													<label class="form-group block clearfix">
														<span class="block input-icon input-icon-right">
															<input type="text" id="txt_nombre" name="txt_nombre" class="form-control" placeholder="Usuario" />
															<i class="ace-icon fa fa-user"></i>
														</span>
													</label>
													<label class="form-group block clearfix">
														<span class="block input-icon input-icon-right">
															<input type="password" id="txt_clave" name="txt_clave" class="form-control" placeholder="Contraseña" />
													...
													<div class="clearfix">
														<button type="submit" id="btn_ingresar" name="btn_ingresar" class="width-40 pull-right btn btn-sm btn-primary">
