app.controller('tipo_ambienteController', function ($scope, $route) {
	...
	jQuery(function($) {
	    ...
	    jQuery(grid_selector).jqGrid({
	    	datatype: "xml",
	        url: 'data/tipo_ambiente/xml_tipo_ambiente.php',
			colNames:['ID','CÓDIGO','AMBIENTE','PRINCIPAL','OBSERVACIONES','FECHA CREACIÓN'],
			colModel:[
				...
				{name:'nombre_tipo_ambiente',index:'nombre_tipo_ambiente',width:250, editable:true, editoptions:{size:"20", maxlength:""}, editrules: {required: true}},
	        ...
	        editurl: "data/tipo_ambiente/app.php",
	        caption: "LISTA TIPO AMBIENTE"
	    });
	    ...
	    },
	    {
	        ...
	        afterSubmit: function(response) {
                ...
                if(retorno == '2') {
                	...
                	if(retorno == '3') {
                		$("#nombre_tipo_ambiente").val("");
	                	return [false,"Error.. El Tipo de Ambiente ya fue Agregado"];
	                }
                }
                return [true,'',retorno];
            },
