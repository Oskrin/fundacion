app.controller('porcentajeController', function ($scope, $route) {
	...
	jQuery(function($) {
	    ...
	    jQuery(grid_selector).jqGrid({
	    	datatype: "xml",
	        url: 'data/porcentaje/xml_porcentajes.php',
			colNames:['ID','NOMBRE','PORCENTAJE','PRINCIPAL','OBSERVACIONES','FECHA CREACIÓN'],
			colModel:[
				{name:'id',index:'id', frozen:true,align:'left',search:false,editable: true, hidden: true, editoptions: {readonly: 'readonly'}},
				{name:'nombre_porcentaje',index:'nombre_porcentaje',width:150, editable:true, editoptions:{size:"20", maxlength:"30"}, editrules: {required: true}},
				{name:'porcentaje', index: 'porcentaje', editable: true, search: false, frozen: true, editrules: {required: true}, align: 'center', editoptions:{maxlength: 10,dataInit: function(elem){$(elem).bind("keypress", function(e) {return ValidNum(e)})}}}, 
	    ...
	    },
	    {
	        ...
	        afterSubmit: function(response) {
                ...
                if(retorno == '2') {
                	...
                	if(retorno == '3') {
                		$("#nombre_porcentaje").val("");
	                	return [false,"Error.. El Porcentaje ya fue Agregado"];
	                }
                }
                return [true,'',retorno];
            },
