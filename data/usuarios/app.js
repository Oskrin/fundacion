app.controller('usuariosController', function ($scope, $route, loaddatosSRI) {
	...
	jQuery(function($) {
    	...
    	$("#logo").attr("src", "data/usuarios/fotos/defaul.jpg");
    	// fin
		...
		jQuery(function($) {
		    ...
		    jQuery(grid_selector).jqGrid({	        
		        ...
		        colNames: ['ID','IDENTIFICACIÓN','NOMBRES COMPLETOS','TELÉFONO','CELULAR','CIUDAD','DIRECCIÓN','CORREO','USUARIO','CLAVE','ID_CARGO','CARGO','FOTO','OBSERVACIONES'],
		        colModel:[      
		        ...
		        ondblClickRow: function(rowid) {     	            	            
	            	...
	            	$("#logo").attr("src", "data/usuarios/"+ ret.foto);
