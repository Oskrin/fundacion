app.controller('tarifa_impuestoController', function ($scope, $route) {
	...
	jQuery(function($) {
	    ...
	    jQuery(grid_selector).jqGrid({
	    	datatype: "xml",
	        url: 'data/tarifa_impuesto/xml_tarifa_impuesto.php',
			...
			colModel:[
	            ...
	            {name:'tipo_impuesto',index:'tipo_impuesto', width:200, hidden:false, editable: true, editrules:{edithidden:true},edittype:"select",
					editoptions: {
						dataUrl:'data/tarifa_impuesto/cargar_tipo_impuesto.php',
				...
				{name:'nombre_tarifa_impuesto',index:'nombre_tarifa_impuesto',width:250, editable:true, editoptions:{size:"20", maxlength:""}, editrules: {required: true}},
	        ...
	        editurl: "data/tarifa_impuesto/app.php",
	        caption: "LISTA TARIFA IMPUESTO"
	    });
	    ...
	    },
	    {
	        ...
	        afterSubmit: function(response) {
                ...
                if(retorno == '2') {
                	...
                	if(retorno == '3') {
                		$("#codigo").val("");
	                	return [false,"Error.. La tarifa Impuesto ya fue Agregada"];
	                }
                }
                return [true,'',retorno];
            },
