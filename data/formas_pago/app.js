app.controller('formas_pagoController', function ($scope, $route) {
	...
	jQuery(function($) {
	    ...
	    jQuery(grid_selector).jqGrid({
	    	datatype: "xml",
	        url: 'data/formas_pago/xml_formas_pago.php',
			colNames:['ID','CÓDIGO','FORMAS PAGO','PRINCIPAL','OBSERVACIONES','FECHA CREACIÓN'],
			colModel:[
				...
				{name:'nombre_forma',index:'nombre_forma',width:250, editable:true, editoptions:{size:"", maxlength:""}, editrules: {required: true}},
	        ...
	        editurl: "data/formas_pago/app.php",
