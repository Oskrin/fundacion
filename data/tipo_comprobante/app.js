app.controller('tipo_comprobanteController', function ($scope, $route) {
	...
	jQuery(function($) {
	    ...
	    jQuery(grid_selector).jqGrid({
	    	datatype: "xml",
	        url: 'data/tipo_comprobante/xml_tipo_comprobante.php',
			colNames:['ID','CÓDIGO','COMPROBANTE','PRINCIPAL','OBSERVACIONES','FECHA CREACIÓN'],
			colModel:[
				...
				{name:'nombre_tipo_comprobante',index:'nombre_tipo_comprobante',width:250, editable:true, editoptions:{size:"20", maxlength:""}, editrules: {required: true}},
	        ...
	        editurl: "data/tipo_comprobante/app.php",
	        caption: "LISTA TIPO COMPROBANTE"
	    });
	    ...
	    },
	    {
	        ...
	        afterSubmit: function(response) {
                ...
                if(retorno == '2') {
                	...
                	if(retorno == '3') {
                		$("#nombre_tipo_comprobante").val("");
	                	return [false,"Error.. El Tipo de Comprobante ya fue Agregado"];
	                }
                }
                return [true,'',retorno];
            },
