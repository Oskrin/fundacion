app.controller('tipo_productoController', function ($scope, $route) {
	...
	jQuery(function($) {
	    ...
	    jQuery(grid_selector).jqGrid({
	    	datatype: "xml",
	        url: 'data/tipo_producto/xml_tipo_producto.php',
			colNames:['ID','CÓDIGO','TIPO PRODUCTO','PRINCIPAL','OBSERVACIONES','FECHA CREACIÓN'],
			colModel:[
				...
				{name:'nombre_tipo_producto',index:'nombre_tipo_producto',width:250, editable:true, editoptions:{size:"20", maxlength:""}, editrules: {required: true}},
	        ...
	        editurl: "data/tipo_producto/app.php",
	        caption: "LISTA TIPO PRODUCTO"
	    });
	    ...
	    },
	    {
	        ...
	        afterSubmit: function(response) {
                ...
                if(retorno == '2') {
                	...
                	if(retorno == '3') {
                		$("#nombre_tipo_producto").val("");
	                	return [false,"Error.. El Tipo de Producto ya fue Agregado"];
	                }
                }
                return [true,'',retorno];
            },
