app.controller('tipo_documentoController', function ($scope, $route) {
	...
	jQuery(function($) {
	    ...
	    jQuery(grid_selector).jqGrid({
	    	datatype: "xml",
	        url: 'data/tipo_documento/xml_tipo_documento.php',
			colNames:['ID','CÓDIGO','DOCUMENTO','PRINCIPAL','OBSERVACIONES','FECHA CREACIÓN'],
			colModel:[
				...
				{name:'nombre_tipo_documento',index:'nombre_tipo_documento',width:250, editable:true, editoptions:{size:"20", maxlength:""}, editrules: {required: true}},
	        ...
	        editurl: "data/tipo_documento/app.php",
	        caption: "LISTA TIPO DOCUMENTO"
	    });
	        ...
	        afterSubmit: function(response) {
                ...
                if(retorno == '2') {
                	...
                	if(retorno == '3') {
	                	...
	                	return [false,"Error.. El Tipo de Documento ya fue Agregado"];
	                }
                }
                return [true,'',retorno];
            },
